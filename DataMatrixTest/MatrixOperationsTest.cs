...
namespace DataMatrixTest
{
    ...
    public class MatrixOperationsTest
    {
        ...
        public void MainDiagonal(Matrix input, int[] expected)                                         //  typeof expression or array creation expression of an attribute parameter type
        {
            MatrixOperations matrixTrace = new MatrixOperations();
            int[] output = matrixTrace.GetMainDiagonal(input);
            CollectionAssert.AreEqual(expected, output);
        ...
        public void SecondaryDiagonal(Matrix input, int[] expected)
        {
            MatrixOperations matrixTrace = new MatrixOperations();
            int[] output = matrixTrace.GetMainDiagonal(input);
            CollectionAssert.AreEqual(expected, output);
